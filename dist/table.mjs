...
class B {
  ...
  constructor(t, e, o, i) {
    this.readOnly = t, this.api = e, this.data = o, this.config = i, this.wrapper = null, this.table = null, this.toolboxColumn = this.createColumnToolbox(), this.toolboxRow = this.createRowToolbox(), this.createTableWrapper(), this.hoveredRow = 0, this.hoveredColumn = 0, this.selectedRow = 0, this.selectedColumn = 0, this.tunes = {
      ...
      const w = r.target.closest(`.${s.addRow}`), p = r.target.closest(`.${s.addColumn}`);
  ...
  addColumn(t = -1, e = !1) {
    ...
    for (let i = 1; i <= this.numberOfRows; i++) {
      ...
      if (t > 0 && t <= o ? (r = this.getCell(i, t), C(n, r)) : r = this.getRow(i).appendChild(n), i === 1) {
   ...
   */
  computeInitialSize() {
    const t = this.data && this.data.content, e = Array.isArray(t), o = e ? t.length : !1, i = e ? t.length : void 0, r = o ? t[0].length : void 0, n = Number.parseInt(this.config && this.config.rows), h = Number.parseInt(this.config && this.config.cols), l = !isNaN(n) && n > 0 ? n : void 0, w = !isNaN(h) && h > 0 ? h : void 0;
    return {
      rows: i || l || 2,
      cols: r || w || 2
    };
  ...
  updateToolboxesPosition(t = this.hoveredRow, e = this.hoveredColumn) {
    this.isColumnMenuShowing || e > 0 && e <= this.numberOfColumns && this.toolboxColumn.show(() => ({
      ...
      const o = this.getRow(t), { fromTopBorder: i } = g(this.table, o), { height: r } = o.getBoundingClientRect();
      return {
   ...
   */
  setLayoutSetting(t) {
    this.tunes.fixedLayout = t, t ? this.table.classList.add(s.fixedLayout) : this.table.classList.remove(s.fixedLayout);
  }
  /**
...
class q {
  ...
  constructor({ data: t, config: e, api: o, readOnly: i }) {
    this.api = o, this.readOnly = i, this.config = e, this.data = {
      ...
      fixedLayout: this.getConfig("fixedLayout", !1, t),
   ...
   */
  render() {
    return this.table = new B(this.readOnly, this.api, this.data, this.config), this.container = c("div", this.api.styles.block), this.container.appendChild(this.table.getWrapper()), this.table.setHeadingsSetting(this.data.withHeadings), this.table.setLayoutSetting(this.data.fixedLayout), this.container;
  }
  /**
  ...
  renderSettings() {
    return [
      ...
      },
      {
        ...
        toggle: !0,
        onActivate: () => {
          this.data.fixedLayout = !0, this.table.setLayoutSetting(this.data.fixedLayout);
        }
      },
      {
        label: this.api.i18n.t("Fixed layout"),
        ...
        toggle: !0,
        onActivate: () => {
          this.data.fixedLayout = !1, this.table.setLayoutSetting(this.data.fixedLayout);
        }
      }
    ];
  }
